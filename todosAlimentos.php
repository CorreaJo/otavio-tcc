...
<body>
    <div class="cadastro-father">
        ...
        <form action="php/alimento/cadastro.php" method="post">    
            ...
            <input class="input-add" type="text" name="tipo" placeholder="Tipo">
        ...
        <?php
            while($linha = mysqli_fetch_assoc($result)){
                ...
                <div class="item-father">
                    ...
                    <h2 class="h2-tipo"><?=$linha["tipo"]?></h2>
                    <a href="php/alimento/deletar.php?id=<?=$linha["id"]?>">EXCLUIR</a>        
                </div>
                <?php
            }
        ?>
